...
ФОРМАТ ОТВЕТА — строго обычный текст, никакого markdown:
- Запрещено: **, __, ##, тройные backtick, * пункт, - пункт, нумерованные списки с точкой.
- Для списков используй эмодзи: 🔹 пункт или просто новую строку.
- Не вставляй сырые URL без необходимости.
- Отвечай живо и коротко, как друг в чате.`;
}
